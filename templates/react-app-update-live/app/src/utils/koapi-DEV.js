...
const pullProducts = () => {
  const config = {
    method: "get",
    url: "https://katalystintegrations.com:4201/api/getProducts",
    headers: {
...
const pullProductPackages = (productId) => {
  const config = {
    method: "get",
    url: "https://katalystintegrations.com:4201/api/getProductPackages",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      id: productId,
    },
...
const pullPreviousPrices = (userEmail, productId, productPackage = "") => {
  const config = {
    method: "post",
    url: "https://katalystintegrations.com:4201/api/getProductPreviousPrices",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
      id: productId,
...
const sendQuoteConfirmationEmail = (userEmail, externalEmail, orderType, orderNumber) => {
  const config = {
    method: "post",
    // url: "https://katalystintegrations.com:4201/api/resendOrderEmail",
    url: "https://katalystintegrations.com:4201/api/resendQuoteEmailDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
      externalEmail,
...
const sendOrderConfirmationEmail = (userEmail, externalEmail, orderType, orderNumber) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/resendOrderEmail",
    url: "https://katalystintegrations.com:4201/api/resendOrderEmailDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
      externalEmail,
...
const pullWarehouseOrders = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/pullOrders",
    url: "https://katalystintegrations.com:4201/api/pullOrdersDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullSiteToSiteOrders = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/pullOrders",
    url: "https://katalystintegrations.com:4201/api/pullSiteToSiteOrdersDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullWarehouseQuotes = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/pullQuotesDev",
    url: "https://katalystintegrations.com:4201/api/pullQuotesDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
...
const pullFuelOrders = (userEmail) => {
  const config = {
    method: "get",
    url: "https://katalystintegrations.com:4201/api/pullFuelOrders",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullFuelQuotes = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/pullFuelQuotes",
    url: "https://katalystintegrations.com:4201/api/pullFuelQuotesDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullMonthlySalesAnalytics = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/orderapp/salesCustomersAnalytics",
    url: "https://katalystintegrations.com:4201/api/orderapp/salesCustomersAnalytics-TESTING",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullMonthlySalesAnalyticsFuel = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/orderapp/salesCustomersAnalytics",
    url: "https://katalystintegrations.com:4201/api/orderapp/salesCustomersAnalyticsFuel-TESTING",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullWarehouseDispatchOrders = (userEmail) => {
  const config = {
    method: "get",
    url: "https://katalystintegrations.com:4201/api/orderapp/pullWarehouseOrdersBySalesman",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullOrderStatus = (userEmail) => {
  const config = {
    method: "get",
    // url: "https://katalystintegrations.com:4201/api/pullOrdersStatusByEmail",
    url: "https://katalystintegrations.com:4201/api/pullOrdersStatusByEmail-TESTING",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      email: userEmail,
    },
...
const pullCustomerAddresses = () => {
  const config = {
    method: "get",
    url: "https://katalystintegrations.com:4201/api/getCustomerAddresses",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
    },
  };
...
const submitOrder = (order, orderType) => {
  const orderSubmitConfig = {
    method: "post",
    url: "https://katalystintegrations.com:4201/api/submitOrder-TESTING",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
...
const submitSiteToSiteOrder = (order, orderType) => {
  const orderSubmitConfig = {
    method: "post",
    // url: "https://katalystintegrations.com:4201/api/submitSiteToSiteOrder",
    url: "https://katalystintegrations.com:4201/api/submitSiteToSiteOrder-TESTING2",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      orderType: orderType || "warehouse",
      "Content-Type": "application/json",
...
const submitQuote = (order, orderType) => {
  const orderSubmitConfig = {
    method: "post",
    // url: "https://katalystintegrations.com:4201/api/submitQuote",
    url: "https://katalystintegrations.com:4201/api/submitQuoteDev",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      orderType: orderType || "warehouse",
      "Content-Type": "application/json",
...
const updateOrder = (order, orderType, orderNumber) => {
  const orderSubmitConfig = {
    method: "post",
    url: "https://katalystintegrations.com:4201/api/editOrder-TESTING",
    headers: {
      apikey: process.env.REACT_APP_NODE_KEY,
      ordertype: orderType || "warehouse",
      ordernumber: orderNumber,
