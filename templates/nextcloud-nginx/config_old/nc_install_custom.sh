...
cp /usr/share/nextcloud/nextcloud_configuration.sh "$SCRIPTS"/nextcloud_configuration.sh
cp /usr/share/nextcloud/sever_configuration.sh "$SCRIPTS"/sever_configuration.sh
cp /usr/share/nextcloud/startup_configuration.sh "$SCRIPTS"/startup_configuration.sh
cp /usr/share/nextcloud/nextcloud-startup-script.sh "$SCRIPTS"/nextcloud-startup-script.sh
# Start changes
